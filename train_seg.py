import torch
from dataset import ShapeNetPartSeg
from model import PVPSegNet
...
param_load_path = "./params/pvpnet-seg-w%d-normal-adam-refine.pth" % w
param_save_path = "./params/pvpnet-seg-w%d-normal-adam-refine.pth" % w
datset_path = "D:/dataset/shapenet_benchmark_v0_normal"
loss_fn = nn.CrossEntropyLoss()

net = PVPSegNet(n_cls=50, w=w)
net.to(device)
...
partseg_dataset_train = ShapeNetPartSeg(datset_path, npoints=point_num, split='trainval', normal_channel=True)
partseg_dataset_test = ShapeNetPartSeg(datset_path, npoints=point_num, split='test', normal_channel=True)
